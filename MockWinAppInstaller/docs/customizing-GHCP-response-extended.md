# Backup copy of customizing-GHCP-response.md (2025-11-05 before rewrite)
...
* Types of customization
  * 1. **Repository custom instruction*****s******  ***f or the codebase-wide context (*Effectiveness*)
    1. **Repo-wide : **
  ...
  * Supportability across dev tools - IDE (‼️ *read carefully*)
    ...
    * GH Copilo t** chat in VSCode** understands all types of repository custom instrunctions
...
| Prohibited dependencies (such as libraries, package managers, specific versions or framworks) | Specialized transformations (such as bulk update, refactoring, or migratons in which you ca n** just copy and paste the prompts**) |
